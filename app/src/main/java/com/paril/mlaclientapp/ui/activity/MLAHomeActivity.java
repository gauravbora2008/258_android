            ...
            public boolean onGroupClick(ExpandableListView expandableListView, View view, int groupPosition, long l) {
                if (expandableListView.getExpandableListAdapter().getChildrenCount(groupPosition) == 0) {
                    if (lastGroupSelPos != groupPosition) {
                        ...
                        // Spring 2020 - Adding menu for social network functionality - Gaurav Bora
                        } else if (listPrimary.get(groupPosition).equals("Social Network")) {

                            // intent, new activity
                            setToolbarTitle("Social Network");

//                            Intent snRegisterIntent = new Intent(this, MLALoginActivity.class);
