...
public class addRequestsAdapter extends RecyclerView.Adapter<addRequestsAdapter.groupsViewHolder> {
    ArrayList<ViewUnjoinedGroupsItem> mGroupList;
    ...
    public addRequestsAdapter(ArrayList<ViewUnjoinedGroupsItem> groupsList) {
    ...
    public groupsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        groupsViewHolder gvh = new groupsViewHolder(v);
        return gvh;
    }
